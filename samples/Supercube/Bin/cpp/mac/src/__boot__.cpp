...
::hxgl::shaders::MVPFun_obj::__register();
::IntIter_obj::__register();
::haxe::io::Bytes_obj::__register();
::haxe::io::Output_obj::__register();
::Supercube_obj::__register();
::hxgl::cross::data::IndexBuffer_obj::__register();
::StringBuf_obj::__register();
::haxe::Log_obj::__register();
::haxe::io::Input_obj::__register();
::cpp::Lib_obj::__register();
::SuperCubeGenerator_obj::__register();
::haxe::io::BytesBuffer_obj::__register();
::cpp::Lib_obj::__boot();
::haxe::Log_obj::__boot();
::cpp::Sys_obj::__boot();
::haxe::io::BytesBuffer_obj::__boot();
::SuperCubeGenerator_obj::__boot();
::haxe::io::Input_obj::__boot();
::StringBuf_obj::__boot();
::hxgl::cross::data::IndexBuffer_obj::__boot();
::Supercube_obj::__boot();
::haxe::io::Output_obj::__boot();
::haxe::io::Bytes_obj::__boot();
::IntIter_obj::__boot();
::hxgl::shaders::MVPFun_obj::__boot();
