...
{
{
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesOutput.hx",35)
...
Void BytesOutput_obj::writeByte( int c){
{
		...
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesOutput.hx",44)
		this->b->b->push(c);
	}
return null();
}
...
int BytesOutput_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesOutput.hx",57)
	{
		HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesOutput.hx",57)
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesOutput.hx",59)
	return len;
}
...
::haxe::io::Bytes BytesOutput_obj::getBytes( ){
	...
	HX_SOURCE_POS("/usr/lib/haxe/std/haxe/io/BytesOutput.hx",126)
