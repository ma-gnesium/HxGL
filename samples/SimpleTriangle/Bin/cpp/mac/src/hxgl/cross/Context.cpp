...
::hxgl::cross::data::VertexBuffer Context_obj::createVertexBuffer( int numVertices,int data32PerVertex){
	...
	::haxe::Log_obj::trace(HX_CSTRING("Pre"),hx::SourceInfo(HX_CSTRING("Context.hx"),133,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createVertexBuffer")));
	...
	::haxe::Log_obj::trace(HX_CSTRING("Created"),hx::SourceInfo(HX_CSTRING("Context.hx"),135,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createVertexBuffer")));
	...
	::haxe::Log_obj::trace(HX_CSTRING("Bound"),hx::SourceInfo(HX_CSTRING("Context.hx"),137,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createVertexBuffer")));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",138)
	...
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",139)
	::haxe::Log_obj::trace(HX_CSTRING("BufferData"),hx::SourceInfo(HX_CSTRING("Context.hx"),139,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createVertexBuffer")));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",140)
	::hxgl::cross::Context_obj::gl->bindBuffer(::hxgl::cross::Context_obj::gl->ARRAY_BUFFER,null());
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",141)
	::haxe::Log_obj::trace(HX_CSTRING("Unbind"),hx::SourceInfo(HX_CSTRING("Context.hx"),141,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createVertexBuffer")));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",142)
	::hxgl::cross::data::VertexBuffer vb = ::hxgl::cross::data::VertexBuffer_obj::__new(id,(data32PerVertex * (int)4));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",145)
	::haxe::Log_obj::trace(HX_CSTRING("return"),hx::SourceInfo(HX_CSTRING("Context.hx"),145,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createVertexBuffer")));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",146)
	return vb;
}
...
::hxgl::cross::data::IndexBuffer Context_obj::createIndexBuffer( int numIndices){
	...
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",155)
	::haxe::Log_obj::trace(HX_CSTRING("Pre"),hx::SourceInfo(HX_CSTRING("Context.hx"),155,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createIndexBuffer")));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",156)
	Dynamic id = ::hxgl::cross::Context_obj::gl->createBuffer();
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",157)
	::haxe::Log_obj::trace((HX_CSTRING("Created: ") + id),hx::SourceInfo(HX_CSTRING("Context.hx"),157,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createIndexBuffer")));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",158)
	::hxgl::cross::Context_obj::gl->bindBuffer(::hxgl::cross::Context_obj::gl->ELEMENT_ARRAY_BUFFER,id);
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",159)
	::haxe::Log_obj::trace(HX_CSTRING("Bound"),hx::SourceInfo(HX_CSTRING("Context.hx"),159,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createIndexBuffer")));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",160)
	...
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",161)
	::haxe::Log_obj::trace(HX_CSTRING("BufferData"),hx::SourceInfo(HX_CSTRING("Context.hx"),161,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createIndexBuffer")));
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",162)
	::hxgl::cross::Context_obj::gl->bindBuffer(::hxgl::cross::Context_obj::gl->ELEMENT_ARRAY_BUFFER,null());
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",163)
	::haxe::Log_obj::trace(HX_CSTRING("Unbind"),hx::SourceInfo(HX_CSTRING("Context.hx"),163,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createIndexBuffer")));
	...
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",167)
	::haxe::Log_obj::trace(HX_CSTRING("pre-return"),hx::SourceInfo(HX_CSTRING("Context.hx"),167,HX_CSTRING("hxgl.cross.Context"),HX_CSTRING("createIndexBuffer")));
...
Void Context_obj::setVertexBufferAt( ::String index,::hxgl::cross::data::VertexBuffer buffer,int bufferOffset,::String format){
{
		...
		HX_SOURCE_POS("../../hxgl/cross/Context.hx",195)
		int type = (int)0;
		HX_SOURCE_POS("../../hxgl/cross/Context.hx",196)
		int size = (int)0;
		HX_SOURCE_POS("../../hxgl/cross/Context.hx",198)
		...
		if (  ( _switch_1==HX_CSTRING("float3"))){
			...
			HX_SOURCE_POS("../../hxgl/cross/Context.hx",202)
			hx::Throw (HX_CSTRING("Invalid format"));
		}
;
;
		HX_SOURCE_POS("../../hxgl/cross/Context.hx",204)
		...
		HX_SOURCE_POS("../../hxgl/cross/Context.hx",206)
		::hxgl::cross::Context_obj::gl->bindBuffer(::hxgl::cross::Context_obj::gl->ARRAY_BUFFER,null());
	}
return null();
}
...
Void Context_obj::setProgram( ::hxgl::cross::data::Program program){
{
		...
		HX_SOURCE_POS("../../hxgl/cross/Context.hx",229)
		::hxgl::cross::Context_obj::__program = program->__prog;
		HX_SOURCE_POS("../../hxgl/cross/Context.hx",230)
...
Void Context_obj::present( ){
{
		...
		HX_SOURCE_POS("../../hxgl/cross/Context.hx",234)
...
Dynamic Context_obj::l( ::String id,int p){
	...
	HX_SOURCE_POS("../../hxgl/cross/Context.hx",254)
